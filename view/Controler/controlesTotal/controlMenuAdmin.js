            ...
            success: function (response) {
                ...
                userDatos.forEach(userDatos => {
                    ...
                    if (userDatos.idEstado == "1") {
                        ...
                        tipoUser = `
                        <buttontype="button" class="btn btn-danger  activarUser" data-bs-toggle="modal" data-bs-target="#ModalactivarUserAux"> <svg xmlns="http://www.w3.org/2000/svg" width="5%" height="5%" fill="currentColor" class="bi bi-person-fill-slash" viewBox="0 0 16 16">
